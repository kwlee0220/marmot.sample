...
//		PropertyConfigurator.configure("log4j.properties");
		...
		DataSet seoul = marmot.getDataSet(FindBestSubway.OUTPUT(ANALY_SEOUL));
		DataSet subway = marmot.getDataSet(FindBestSubway.OUTPUT(ANAL_STATIONS));
		
		// 격자별 집계구 비율 계산
		DataSet ds = FindBestSubway.calcBlockRatio(marmot, seoul, subway, FindBestSubway.OUTPUT(ANALY_BLOCK_RATIO));
